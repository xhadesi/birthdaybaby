...
const TRANSLATIONS = {
  zh: {
    ...
    timeline3Title: "10月重庆度假见 • 明年定居重庆天天相伴 ✈️",
  ...
  en: {
    ...
    timeline3Title: "October Vacations in Chongqing • Moving Next Year ✈️",
    ...
    quest3Btn: "Make Wish & Blow Candles 🕯️",
